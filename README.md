# Documentação do Sistema: ProNetwork

## Sobre o Projeto
A **ProNetwork** é uma plataforma social profissional puramente frontend, voltada para a Geração Z. Ela oferece:
...
*Nota: Durante o ambiente de desenvolvimento local, utilize o servidor embutido (`npm run dev`) para garantir o funcionamento correto de importações de módulos e rotas dinâmicas do React.*
